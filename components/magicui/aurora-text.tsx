...
export function AuroraText({
    ...
    useEffect(() => {
        const updateDimensions = () => {
            if (containerRef.current) {
                /* Use the container’s dimensions instead of the SVG text */
                const bbox = containerRef.current.getBoundingClientRect();
                /* Loads the rest of the component only if the dimensions are defined, ensuring the default display remains otherwise. */
